...
This will load the `808 Shooter.py` module by path and call the adaptive
...
ROOT = HERE.parent
SHOOTER_PATH = ROOT / "808 Shooter.py"
if not SHOOTER_PATH.exists():
    print("Cannot locate '808 Shooter.py' at expected path:", SHOOTER_PATH)
    sys.exit(2)
