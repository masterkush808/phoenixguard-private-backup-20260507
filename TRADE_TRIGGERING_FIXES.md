...
2. Amount field click:         0.12s setup + click
3. Amount entry:               0.08s + 0.10s + 0.28s = 0.46s
4. Window activation:          0.16s
5. Pre-click verification:     immediate
6. Button click:               0.14s lock + click
7. Broker processing:          0.45s
8. Verification:               immediate + up to 0.50s retry
Total button time:             ~2-3 seconds
...
4. Before amount field click, 0.12s
