...
class RLPolicyEngine:
    ...
    def infer(
        ...
        *,
        ...
        boost_applied = False
        if float(memory_recall_top1_sim) >= _MEMORY_BOOST_THRESHOLD and _safe_action(memory_recall_direction) in {"BUY", "SELL"}:
    ...
    def record_inference_context(
        ...
        *,
        ...
        self._pending_contexts[image_key] = {
    ...
    def record_feedback(
        ...
        *,
        ...
        self._append_feedback_item(feedback_item)
    ...
    def online_update(self, batch: list[dict[str, Any]]) -> float:
        ...
        reward_weights = rewards.clamp(min=0.25, max=3.0)
