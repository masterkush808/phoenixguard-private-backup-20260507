...
- local execution packet endpoint: `Backend/src/phoenixguard/mobile_api/app.py`
- MT4 file bridge: `Backend/tools/phoenixguard_mt4_file_bridge.py`
- MT4 EA: `Backend/launch/mt4/PhoenixGuard_MT4_Executioner.mq4`
- VM/Cloudflare deployment guide: `Backend/launch/deploy/windows/WINDOWS_VM_CLOUDFLARE_TUNNEL.md`
