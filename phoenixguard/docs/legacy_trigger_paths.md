...
| Model Council `STUDY_PACKET`                                       | `Backend/src/phoenixguard/decision/model_council_v3.py` | Visibility only           | never clicked by shooter                                                      |
| Model Council `PG_EXECUTION_PACKET_V3` + `PG_ALLOWANCE_PACKAGE_V1` | `Backend/src/phoenixguard/decision/model_council_v3.py` | Package handoff authority | only this pair can reach the local package reporter and MT4 bridge            |
