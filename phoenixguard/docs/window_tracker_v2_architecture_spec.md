# Window Tracker V2 Architecture Specification (archived summary)

The full V2 architecture specification has been archived to:

- `docs/archive/window_tracker_v2_architecture_spec.md`

Operator note: the archived file contains the complete modular design, runtime topology, data contracts, and the migration plan for V2. Use that archived document for engineering work, migration planning, or when implementing worker stages and replay infrastructure.

For operational checks and the current production behavior, refer to the live tracker deep-dive archive and the operator runbook in `README.md`.
