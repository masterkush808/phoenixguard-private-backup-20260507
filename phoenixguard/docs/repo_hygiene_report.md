...
| `tools/phoenixguard_mt4_file_bridge.py`     | ACTIVE_SUPPORT | package-aware MT4 command bridge and allowance revalidator                          |
| `mt4/PhoenixGuard_MT4_Executioner.mq4`      | ACTIVE_SUPPORT | MT4 external execution consumer with intraday/swing package controls                |
