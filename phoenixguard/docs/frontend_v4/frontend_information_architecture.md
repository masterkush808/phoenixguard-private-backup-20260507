...
| Study | Inspect continuous closed-candle regression, Pair DNA similarity, and completed historical behavior. | `.history-module`, `#history-list`, `#history-caption`, `.history-item`, `.history-copy`, `.history-meta` |
...
| Settings | Operate tracker mode, execution mode, public safety gates, layer visibility, and emergency controls. | `.control-ribbon`, `.action-group`, `.mode-group`, `#tracker-toggle`, `#execution-toggle`, `#execution-mode-toggle`, `#emergency-stop`, `#identity-gate-toggle`, `#refresh-now`, `#mode-overlay`, `#mode-raw`, `.layer-controls`, `.layer-toggle` |
