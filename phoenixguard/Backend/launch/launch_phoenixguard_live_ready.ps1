...
$env:PHOENIXGUARD_ARTIFACT_PNG_COMPRESS_LEVEL = '3'
...
$env:PHOENIXGUARD_TRACKER_ARTIFACT_PRUNE_INTERVAL_SEC = '60.0'
Set-PhoenixGuardDefaultProcessEnvironment -Name 'PHOENIXGUARD_TRACKER_ARTIFACT_RETENTION_FRAMES' -Value '48'
