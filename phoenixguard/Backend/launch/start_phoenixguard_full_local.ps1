...
$env:PHOENIXGUARD_BACKGROUND_CAPTURE_ONLY = if ($env:PHOENIXGUARD_BACKGROUND_CAPTURE_ONLY) { $env:PHOENIXGUARD_BACKGROUND_CAPTURE_ONLY } else { '1' }
$env:PHOENIXGUARD_POCKET_FAST_FOREGROUND_IMAGEGRAB = if ($env:PHOENIXGUARD_POCKET_FAST_FOREGROUND_IMAGEGRAB) { $env:PHOENIXGUARD_POCKET_FAST_FOREGROUND_IMAGEGRAB } else { '0' }
$env:PHOENIXGUARD_CAPTURE_ACTIVATE_WINDOW_FALLBACK = if ($env:PHOENIXGUARD_CAPTURE_ACTIVATE_WINDOW_FALLBACK) { $env:PHOENIXGUARD_CAPTURE_ACTIVATE_WINDOW_FALLBACK } else { '0' }
$env:PHOENIXGUARD_TRACKER_RESTORE_LOCKED_WINDOW = if ($env:PHOENIXGUARD_TRACKER_RESTORE_LOCKED_WINDOW) { $env:PHOENIXGUARD_TRACKER_RESTORE_LOCKED_WINDOW } else { '0' }
$env:PHOENIXGUARD_DISPLAY_FAST_VISIBLE_CAPTURE = if ($env:PHOENIXGUARD_DISPLAY_FAST_VISIBLE_CAPTURE) { $env:PHOENIXGUARD_DISPLAY_FAST_VISIBLE_CAPTURE } else { '0' }
