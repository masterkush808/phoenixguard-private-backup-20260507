...
$CaptureIntervalSec = [double](Get-EnvOrDefault -Name 'PHOENIXGUARD_TRACKER_CAPTURE_INTERVAL_SEC' -DefaultValue '30.0')
...
$ShooterPollSec = [double](Get-EnvOrDefault -Name 'PHOENIXGUARD_SHOOTER_POLL_SEC' -DefaultValue '30.0')
...
$VisibilityRecoveryEnabled = ConvertTo-BoolFlag -Value (Get-EnvOrDefault -Name 'PHOENIXGUARD_MONITOR_VISIBILITY_RECOVERY_ENABLED' -DefaultValue '0') -DefaultValue $false
