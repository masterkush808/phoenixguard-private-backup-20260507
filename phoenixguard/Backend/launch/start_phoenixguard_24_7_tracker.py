...
def main() -> int:
    ...
    os.environ.setdefault("PHOENIXGUARD_BACKGROUND_CAPTURE_ONLY", "1")
    os.environ.setdefault("PHOENIXGUARD_DISPLAY_FAST_VISIBLE_CAPTURE", "0")
    ...
    os.environ.setdefault("PHOENIXGUARD_CAPTURE_ACTIVATE_WINDOW_FALLBACK", "0")
    os.environ.setdefault("PHOENIXGUARD_TRACKER_RESTORE_LOCKED_WINDOW", "0")
    os.environ.setdefault("PHOENIXGUARD_FAST_FOCUS_PREVIEW", "0")
    ...
    os.environ.setdefault("PHOENIXGUARD_ARTIFACT_PNG_COMPRESS_LEVEL", "3")
    ...
    os.environ.setdefault("PHOENIXGUARD_TRACKER_ARTIFACT_RETENTION_FRAMES", "48")
    os.environ.setdefault("PHOENIXGUARD_TRACKER_ARTIFACT_MAX_AGE_SEC", "1800")
    os.environ.setdefault("PHOENIXGUARD_TRACKER_ARTIFACT_MAX_MB", "64")
    os.environ.setdefault("PHOENIXGUARD_TRACKER_ARTIFACT_PRUNE_INTERVAL_SEC", "60.0")
    os.environ.setdefault("PHOENIXGUARD_MARKET_REGISTRY_MAX_BYTES", str(8 * 1024 * 1024))
    os.environ.setdefault("PHOENIXGUARD_MARKET_REGISTRY_RETAIN_LINES", "2000")
