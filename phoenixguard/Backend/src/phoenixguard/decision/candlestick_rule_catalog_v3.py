...
ADVANCED_CANDLE_FILTER_CATALOG_V3: tuple[dict[str, Any], ...] = tuple(
    ...
    for rule_id, start, end, required in (
        ...
        ("SANSEN_THREE_RIVERS", 256, 263, "CLOSED_CANDLES_AND_SWINGS"),
        ("SANKU_THREE_GAPS", 256, 266, "CLOSED_CANDLES_AND_SWINGS"),
        ("SANPEI_THREE_PARALLEL_LINES", 256, 256, "CLOSED_CANDLES_AND_SWINGS"),
        ("SANPO_THREE_METHODS", 256, 270, "CLOSED_CANDLES_AND_SWINGS"),
        ("THREE_BUDDHA_TOP", 257, 257, "PRICE_STRUCTURE"),
        ("INVERTED_THREE_BUDDHA_TOP", 258, 258, "PRICE_STRUCTURE"),
        ("FRY_PAN_BOTTOM", 259, 259, "PRICE_STRUCTURE"),
        ("DOUBLE_TOP_FILTER", 260, 260, "PRICE_STRUCTURE"),
        ("TWO_CROWS_FILTER", 261, 262, "CLOSED_CANDLES_AND_SWINGS"),
        ("UNIQUE_THREE_RIVER_BOTTOM", 263, 263, "CLOSED_CANDLES_AND_SWINGS"),
        ("THREE_UPSIDE_GAPS", 264, 265, "CLOSED_CANDLES_AND_SWINGS"),
        ("THREE_DOWNSIDE_GAPS", 265, 266, "CLOSED_CANDLES_AND_SWINGS"),
        ("SIMULTANEOUS_THREE_WINGS", 266, 267, "CLOSED_CANDLES_AND_SWINGS"),
        ("RISING_THREE_METHODS_FILTER", 269, 269, "CLOSED_CANDLES_AND_SWINGS"),
        ("FALLING_THREE_METHODS_FILTER", 270, 270, "CLOSED_CANDLES_AND_SWINGS"),
        ("P_I_SYSTEM_TRADER", 247, 252, "PRICE_STRUCTURE"),
        ("COMPUTERIZED_CANDLE_SCANNING", 273, 284, "CLOSED_CANDLE_GEOMETRY"),
        ("NISON_CANDLE_SCANNER_FEATURES", 275, 279, "CLOSED_CANDLE_GEOMETRY"),
        ("NISON_CANDLE_HIGHLIGHTER_MT4", 280, 284, "CLOSED_CANDLE_GEOMETRY"),
    )
)
