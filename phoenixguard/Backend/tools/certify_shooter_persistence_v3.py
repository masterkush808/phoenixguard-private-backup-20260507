...
def main() -> int:
    ...
    report = gate_report(
        ...
        details={
            ...
            "launch_command": r".\.venv-live\Scripts\python.exe Backend\launch\shooter.py signal --base-url http://127.0.0.1:8793 --session-id pocket-live-8788 --poll 30.0 --heartbeat 4.0",
        },
    )
